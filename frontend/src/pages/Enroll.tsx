        ...
        <div className="py-10">
            ...
            <div className="flex md:flex-row flex-col md:w-8/12 w-10/12 rounded-xl mx-auto shadow-lg overflow-hidden">
                ...
                <div className="w-full flex-col md:w-1/2 py-16 px-12">
                    <h2 className="text-3xl mb-4">สร้างแอคเคาท์สำหรับคู่ค้า</h2>
                    <p className="mb-4">
                        สร้างแอคเคาท์เพื่อลงทะเบียนและจัดการที่พักของท่าน
                    </p>
                    ...
                    <form onSubmit={onSubmit}>
                        ...
                        <div>
                            <input
                                ...
                                type="hidden"
                                value="admin" // กำหนด role เป็น admin
                            /></div>
                    </form>
                    <div className="w-full flex md:flex-row flex-col pt-8">
                        <p className="w-full font-normal text-center text-[16px] leading-[27px] text-black border-t-[1px] border-t-[#5d5d5d] pt-5">
                            สร้างแอคเคาท์เพื่อจองที่พักของท่าน?<br />
                            <Link to="/register/" className="text-blue-800 font-semibold">
                                สร้างแอคเคาท์สำหรับลูกค้า
                            </Link>{" "}
                        </p>
                    </div>
                </div>
