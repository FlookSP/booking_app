                ...
                <div>
                    <div className="relative ml-24">
                        ...
                        <div className={`absolute right-0 mt-0 w-48 bg-white rounded-sm overflow-hidden shadow-lg z-20 border border-gray-100 ${dropdown ? "" : "hidden"} `}>
                            <Link to="#" title="Share on Facebook (NB! does not work in this demo)" className="flex px-4 py-2 text-sm text-gray-800 border-b hover:bg-blue-100">
                                <HiLink className="text-gray-500 h-5 w-6 mr-3" />
                                <span className="text-gray-600">คัดลอกลิงค์</span>
                            </Link>
                            <Link to="#" title="Share on Twitter (NB! does not work in this demo)" className="flex px-4 py-2 text-sm text-gray-800 border-b hover:bg-blue-100">
